...
var content = $('<div class="timepicker">\
		<div v-show class="title">Seleccione Hora</div>\
			<div class="chose-all">\
				<div class="handle">\
				...
				<div class="text">\
					<div class="cell-4"><a class="js-hour-show" title="Horas"></a></div>\
					<div class="cell-2">:</div>\
					<div class="cell-4"><a class="js-minute-show" title="Minutos"></a></div>\
				</div>\
				<div class="handle">\
